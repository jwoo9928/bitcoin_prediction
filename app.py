...
if st.button("그래프 분석 & 시각화"):
    ...
    print(base_end_ts)
    predictions = gpts.predict_bitcoin_prices(weekly_data, base.tail(30), base_end_ts, 'prompt.txt')
    # predictions = pd.read_csv("output.csv", parse_dates=["Open time"], index_col="Open time")
